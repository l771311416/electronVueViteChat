      ...
      <template #header="{ date }">
        <div class="flex justify-between items-center w-full h-full">
          <div class="flex w-240px items-center">
            <span class="inline-block mr-15px text-ele-gray-hight"
              >我的日程</span
            >
            <!--根据年月日选择上一月，下一年等 -->
            <div
              class="flex justify-between items-center w-50px h-50px mr-15px"
            >
              <div
                @click="preDate()"
                class="inline-block"
            ...
            <span class="mr-10px font-semibold subpixel-antialiased">{{
              date
            }}</span>
          </div>
        ...
        <div :class="data.isSelected ? 'is-selected' : ''">
          ...
          >
            ...
            <template #default>
              ...
              >
                <div
                  class="hover:bg-slate-50 hover:shadow-lg h-30px leading-30px font-medium"
                  @click="goMeeting"
                  ><span>开 会</span>
                </div>
                <div
